...
enablePin.period_us(20000);//20 ms (RC SERVO PERIOD)
var value = 1.0;// 100/%
...
{  
    if (ledState) {
        enablePin.write(0.1);  // 0.075 = 3/40 ... 20ms *0.075 = 1.5ms neutral position
                               // 20ms* 0.1 = 2.0ms upper limit position
                               // 20ms* 0.05= 1.0ms lower limit position
    }

    else {
        enablePin.write(0.05);
    }
